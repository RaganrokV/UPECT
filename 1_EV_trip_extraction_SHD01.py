...
for i in range(1, 21):
    ...
    combined_data['VIN'] = f'SHD01Y21V{i}'
    ...
    SHD01Y21.append(combined_data)


combined_df = pd.concat(SHD01Y21, ignore_index=True)
...
with open('11-pretrained_incremental_learning/data/SHD01Y21.pkl', 'wb') as f:
    pickle.dump(SHD01Y21, f)
